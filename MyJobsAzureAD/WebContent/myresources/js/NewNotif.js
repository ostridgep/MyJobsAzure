...
var formNewNotif = new sap.m.Dialog("dlgNewNotif",{
					...
					new sap.m.Button( {
					    ...
					    tap: [ function(oEvt) {	
					    	...
					    	if(error){
					    		...
					    		DisplayErrorMessage("Create Job - Error", "Please enter Notification type, Group Type , Code Type, Priority, Start Date, Description,\n (Functional Location or Equipment Number).");
					    	}
					    	else{
	...
	beforeOpen:function(){
      ...
      afterOpen:function(){
    	  document.getElementById("NewNotifStart-inner-inner").disabled=true;
      }
	 })
